...
% Emphasize that the simulator is more abstract and for comparing the heuristics in the ideal case so doesn't simulate e.g., cache misses, other more complex behaviour. It is simply a framework for comparing alternative heuristics themselves. 
...
% More detail for this table: worst and best cases too? 
