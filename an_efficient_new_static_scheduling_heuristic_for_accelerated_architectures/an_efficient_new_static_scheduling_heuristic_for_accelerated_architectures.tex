...
The relative performance of the heuristics was rather variable for the randomly-generated DAGs, depending on the target platform and acceleration regime. However both HOFT and HEFT-WM achieved smaller makespans than HEFT on average. Table \ref{tb.hoft_random_DAGs} summarizes the results... Also included in the table is HOFT-WM, the heuristic obtained by using the HEFT-WM task prioritization phase with the HOFT processor selection.  
% TODO.
...
\begin{table}
	...
	\begin{center}	
		\begin{tabular}{c c c c c c}
			\toprule
			& \multicolumn{2}{c}{1 GPU, 1 CPU} && \multicolumn{2}{c}{ 4 GPUs, 4 CPUs}\\
